...
<style>
  .embla {
    ...
    --accent-soft: #4ade80;
    --dot: #94a3b8;
    --thumb-gap: var(--embla-thumb-gap, 0.5rem);
    --thumb-spacing: var(--embla-thumb-spacing, 0.35rem);
    --thumb-size: var(--embla-thumb-size, 88px);
    --thumb-max-width: var(--thumb-size);
    --thumb-height: var(
      --embla-thumb-height,
      var(--thumb-size)
    );
    --thumb-column-size: min(var(--thumb-size), 32vw);
    --embla-thumbs-visible: 5;
    position: relative;
    width: min(100%, 920px);
    margin-inline: auto;
  ...
  .embla__thumbs--bottom {
    margin-top: 8px;
  }
  .embla__layout--thumbs-left,
  .embla__layout--thumbs-right {
    grid-template-columns:
      minmax(0, var(--thumb-column-size))
      minmax(0, 1fr);
    align-items: stretch;
  }
  ...
  .embla__slide--selected {
    opacity: 1;
    animation: embla-main-slide-fade-in
      calc(var(--embla-transition-ms) * 1ms) ease;
  }

  @keyframes embla-main-slide-fade-in {
    from {
      opacity: 0.55;
    }
  ...
  .embla__controls--outside.embla__controls--middle
    .embla__controls-side--left {
    position: absolute;
    left: -3.25rem;
  }

  .embla__controls--outside.embla__controls--middle
    .embla__controls-side--right {
    position: absolute;
    right: -3.25rem;
  }
  ...
  .embla__controls--inside {
    ...
    z-index: 4;
    pointer-events: none;
    padding-inline: var(--embla-inside-edge, 10px);
    justify-content: center;
  }
  ...
  .embla__thumbs--top .embla__thumbs-viewport,
  .embla__thumbs--bottom .embla__thumbs-viewport {
    ...
    width: min(
      ...
      calc(
        (
            var(--thumb-max-width) *
              var(--embla-thumbs-visible)
          ) +
          (
            var(--thumb-gap) *
              (var(--embla-thumbs-visible) - 1)
          ) +
          4px
      )
    );
  ...
  .embla__thumbs--left .embla__thumbs-container,
  .embla__thumbs--right .embla__thumbs-container {
    flex-direction: column;
  }

  .embla__thumbs--top .embla__thumbs-container,
  .embla__thumbs--bottom .embla__thumbs-container {
    justify-content: flex-start;
  }

  .embla__thumbs--top.embla__thumbs--align-start
    .embla__thumbs-viewport,
  .embla__thumbs--bottom.embla__thumbs--align-start
    .embla__thumbs-viewport {
    margin-inline: 0 auto;
  }

  .embla__thumbs--top.embla__thumbs--align-center
    .embla__thumbs-viewport,
  .embla__thumbs--bottom.embla__thumbs--align-center
    .embla__thumbs-viewport {
    margin-inline: auto;
  }

  .embla__thumbs--top.embla__thumbs--align-end
    .embla__thumbs-viewport,
  .embla__thumbs--bottom.embla__thumbs--align-end
    .embla__thumbs-viewport {
  ...
  .embla__thumbs--right {
    align-self: stretch;
    width: var(--thumb-column-size);
    max-width: var(--thumb-column-size);
    height: 100%;
    max-height: 100%;
    min-height: 0;
    min-width: 0;
  ...
  .embla__thumbs--left .embla__thumbs-viewport,
  .embla__thumbs--right .embla__thumbs-viewport {
    width: 100%;
    height: 100%;
    max-height: 100%;
    overflow-y: auto;
  ...
  .embla__thumb {
    ...
    box-sizing: border-box;
    transition:
      border-color calc(var(--embla-transition-ms) * 1ms)
        ease,
      transform calc(var(--embla-transition-ms) * 1ms) ease,
      box-shadow calc(var(--embla-transition-ms) * 1ms) ease;
  }

  .embla__thumbs--left .embla__thumb,
  .embla__thumbs--right .embla__thumb {
  ...
  .embla__thumbs--left.embla__thumbs--align-start
    .embla__thumbs-container,
  .embla__thumbs--right.embla__thumbs--align-start
    .embla__thumbs-container {
    justify-content: flex-start;
  }

  .embla__thumbs--left.embla__thumbs--align-center
    .embla__thumbs-container,
  .embla__thumbs--right.embla__thumbs--align-center
    .embla__thumbs-container {
    justify-content: center;
  }

  .embla__thumbs--left.embla__thumbs--align-end
    .embla__thumbs-container,
  .embla__thumbs--right.embla__thumbs--align-end
    .embla__thumbs-container {
  ...
  :global(.goverlay .embla-glb-counter) {
    position: fixed;
    right: 16px;
    bottom: 16px;
    z-index: 10001;
  ...
  .embla__thumbs-viewport {
    ...
    scrollbar-color: rgba(100, 116, 139, 0.9)
      rgba(15, 23, 42, 0.35);
  }

  .embla__thumbs-viewport::-webkit-scrollbar {
    width: 10px;
    height: 10px;
  }

  .embla__thumbs-viewport::-webkit-scrollbar-track {
    background: rgba(15, 23, 42, 0.35);
    border-radius: 999px;
  }

  .embla__thumbs-viewport::-webkit-scrollbar-thumb {
  ...
  .embla__thumbs-viewport::-webkit-scrollbar-thumb:hover {
    background: linear-gradient(
      180deg,
